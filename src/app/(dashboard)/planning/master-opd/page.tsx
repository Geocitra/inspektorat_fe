// src/app/(dashboard)/planning/master-opd/page.tsx
'use client';
...
import OpdList from '@/features/planning/components/OpdList';
        ...
        return (
            <div className="max-w-md mx-auto my-12 text-center p-8 border border-slate-200 bg-white rounded-none">
                ...
                <p className="text-slate-500 text-xs mt-2 mb-6 leading-relaxed">
                    Maaf, Anda tidak memiliki wewenang untuk mengakses modul Master OPD. Halaman ini hanya diperuntukkan bagi Kasubag Perencanaan.
                </p>
                <Link href="/">
