...
import { 
    Download, UploadCloud, FileText, CheckCircle2, AlertTriangle, Building, ArrowRight 
} from 'lucide-react';
    ...
    if (!st || !nhp) {
        return (
            <div className="max-w-md mx-auto my-12 text-center p-8 border border-slate-200 bg-white rounded-none">
                ...
                <h2 className="text-lg font-bold text-slate-800">Menunggu Dokumen NHP</h2>
                <p className="text-slate-500 text-xs mt-2 mb-6 leading-relaxed">
                    Inspektorat belum mempublikasikan Naskah Hasil Pemeriksaan (NHP) untuk Surat Tugas ini ke portal Anda. Harap hubungi tim pemeriksa terkait.
                </p>
            </div>
        );
    }
        ...
        <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="border border-slate-200 bg-slate-800 text-white p-5 rounded-none space-y-2 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div className="space-y-0.5">
                    ...
                    <p className="text-[10px] text-slate-350">Agenda: {st.namaAudit} ({st.noSt})</p>
                </div>
                <span className="text-[9px] font-bold px-2 py-0.5 bg-blue-600 text-white rounded-none">
                    Status: {nhp.status.replace('_', ' ')}
                </span>
            </div>
            ...
            <div className="border border-slate-200 bg-white p-5 rounded-none space-y-4">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-slate-50 p-4 border border-slate-150 rounded-none">
                    <div className="space-y-1">
                        <p className="text-xs font-bold text-slate-800">Draft_NHP_{st.noSt.replace(/\//g, '_')}.pdf</p>
                    ...
                    <Button 
                        ...
                        className="bg-blue-600 hover:bg-blue-700 text-xs font-bold rounded-none shadow-none flex items-center gap-1.5 shrink-0"
                    >
            ...
            <div className="border border-slate-200 bg-white p-5 rounded-none space-y-4">
                <div className="border-b border-slate-100 pb-2">
                    ...
                    <p className="text-[10px] text-slate-400 mt-0.5">Kirimkan berkas surat sanggahan resmi/adendum dalam bentuk PDF.</p>
                </div>
